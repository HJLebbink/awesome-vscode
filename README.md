...
- [ASM](https://marketplace.visualstudio.com/items?itemName=Henk-JanLebbink.AsmDude) Syntax highlighting (Intel syntax), Intellisense, auto-completion, documentation, performance information.
